				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
					...
					<div className="relative group p-8 md:p-10 rounded-2xl border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-all duration-300">
						...
						<p className="text-muted-foreground text-lg leading-relaxed mb-8">
							If you&apos;re a Deakin student who wants to build real projects,
							meet other developers, and feel more confident about internships
							and grad roles, we&apos;d love to see you at a DSEC event this
							trimester.
						</p>

						<Link
							href="https://www.dusa.org.au/clubs/deakin-software-engineering-club-dsec"
							className="w-full sm:w-fit px-8 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full font-semibold group flex items-center justify-center gap-2 transition-all"
						>
					...
					<div className="relative group p-8 md:p-10 rounded-2xl border border-secondary/20 bg-secondary/5 hover:bg-secondary/10 transition-all duration-300">
						...
						<p className="text-muted-foreground text-lg leading-relaxed mb-8">
							If you&apos;re an industry partner, recruiter, or staff member who
							wants to work with motivated Deakin students, reach out. We can
							help with guest talks, workshops, hackathons, and project
							collaborations.
						</p>

						<Link
							href="/partnerships"
							className="w-full sm:w-fit px-8 py-3 border border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground rounded-full font-semibold group flex items-center justify-center gap-2 transition-all"
						>
