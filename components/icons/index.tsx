...
export function ArrowSmallIcon(props: IconProps): ReactElement {
  return (
    <svg
      className="w-4 h-4"
      fill="none"
...
export function MailSmallIcon(props: IconProps): ReactElement {
  return (
    <svg
      className="w-4 h-4"
      fill="none"
...
// Social icon component that selects the right icon based on platform name
export function SocialIcon({
  name,
  ...props
}: { name: string } & IconProps): ReactElement | null {
  switch (name) {
    case "Discord":
