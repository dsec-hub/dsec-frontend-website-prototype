...
export default function PartnershipsHero() {
	return (
		<section className="relative min-h-[80vh] overflow-hidden bg-background">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
					...
					<div>
						...
						<p className="text-xl text-secondary font-medium mb-6">
							Partner with DSEC to support motivated students, share your
							expertise, and build relationships with emerging tech talent at
							Deakin University.
						</p>

						<div className="space-y-4 text-muted-foreground text-lg leading-relaxed mb-10">
							<p>
								DSEC partnerships create meaningful connections between industry
								professionals and Deakin students who are serious about software
								engineering. Whether you&apos;re looking to mentor, recruit, or
								collaborate on projects, we offer flexible ways to engage with
								our community.
							</p>
							<p>
								From guest talks and workshops to hackathon sponsorships and
								portfolio reviews, our partnerships are designed to deliver real
								value for both companies and students while strengthening
								Melbourne&apos;s tech ecosystem.
							</p>
						</div>
			...
			<div className="absolute top-20 right-20 text-6xl text-secondary/10 font-mono animate-float">
				🤝
			</div>
			<div
				className="absolute bottom-40 left-16 text-5xl text-accent/10 font-mono animate-float"
				style={{ animationDelay: "2s" }}
			>
				{"{ }"}
			</div>
			<div
				className="absolute top-1/2 right-12 text-4xl text-primary/10 font-mono animate-float"
		...
		<div className="relative w-full max-w-md aspect-square">
			...
			{[0, 72, 144, 216, 288].map((angle, i) => {
				...
				return (
					...
					>
						<div
							className={`w-4 h-4 ${colors[i]} rounded-full animate-pulse`}
