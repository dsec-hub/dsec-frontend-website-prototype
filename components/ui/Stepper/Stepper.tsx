...
export default function Stepper({
  ...
  // Update direction when controlled step changes
  React.useEffect(() => {
    if (controlledStep !== undefined) {
    ...
    <div className="flex flex-col w-full" {...rest}>
      <div className={`mx-auto w-full ${stepCircleContainerClassName}`}>
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={`px-4 sm:px-6 ${contentClassName}`}
        >
          {stepsArray[currentStep - 1]}
        </StepContentWrapper>

        {!isCompleted && !hideNavigation && (
          <div className={`px-4 sm:px-6 pb-6 ${footerClassName}`}>
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: '#e91e63', color: '#e91e63' },
          complete: { scale: 1, backgroundColor: '#e91e63', color: '#e91e63' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: '#e91e63' }
  };
